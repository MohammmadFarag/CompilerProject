    ...
    class Analyze {
        ...
        private bool isKeyword(string sToken) {
            ...
            var sKeywords = new List<string>(){
                "Pattern","DerivedFrom","TrueFor","Else","Ity","Sity","Cwq","CwqSequence","Ifity","Sifity","Valueless","Logical",
                "BreakFromThis", "Whatever","Respondwith","Srap","Scan–Conditionof","","Require"};
            return sKeywords.Exists(element => (sToken.ToLower()) == element);
        }
        public string Result(string txt,string tt = @"transitiontable.txt") {
            try {
